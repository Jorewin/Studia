...
@correctness
def c_help(command: str = None) -> str:
    """
...
@add_to_switch(switch=controller.commands, name="settings")
@correctness
def c_settings() -> str:
    """
...
@add_to_switch(switch=controller.commands, name="set")
@correctness
def c_set(key: str, value: int) -> str:
    """
